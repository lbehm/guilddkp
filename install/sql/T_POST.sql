...
`post_user_id`  smallint(5) NOT NULL ,
`post_user_name`  varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' ,
`post_timestamp`  int(11) UNSIGNED NOT NULL ,
`post_text`  longtext CHARACTER SET utf8 COLLATE utf8_bin NOT NULL ,
`post_sticky`  bit(1) NOT NULL DEFAULT b'0' ,
`post_delete`  bit(1) NOT NULL DEFAULT b'0' ,
`post_edit_user_id`  smallint(5) NOT NULL ,
...
FOREIGN KEY (`post_user_id`) REFERENCES `dkp_user` (`user_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
