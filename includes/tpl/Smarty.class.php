 ...
 */
	...
	/**
     * set Template-Directorys
	 * set template_dir, compile_dir and config_dir
     *
     * @param string $tpl_var the template subdirectory-variable / templatename
     */
    function setTpl($dir=null)
	{
		if(isset($dir))
		{
			$tplDir = $this->template_dir.DIRECTORY_SEPARATOR.$dir.DIRECTORY_SEPARATOR;
			$this->template_dir = $tplDir.'templates';
			$this->compile_dir = $tplDir.'compile';
